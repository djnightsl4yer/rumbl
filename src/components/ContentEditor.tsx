      ...
      <div className="bg-gray-900/50 backdrop-blur-sm border border-red-500/30 rounded-xl p-6">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            disabled={loading}
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 px-6 py-3 rounded-lg font-bold transition-all"
          >
            <Save size={20} />
            SAUVEGARDER HERO
          </button>
      ...
      <div className="bg-gray-900/50 backdrop-blur-sm border border-red-500/30 rounded-xl p-6">
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              type="text"
              value={content.next_event?.title || ''}
              onChange={(e) => setContent({
                ...content,
                next_event: { ...content.next_event, title: e.target.value }
              })}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500"
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={content.next_event?.event || ''}
              onChange={(e) => setContent({
                ...content,
                next_event: { ...content.next_event, event: e.target.value }
              })}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500"
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={content.next_event?.location || ''}
              onChange={(e) => setContent({
                ...content,
                next_event: { ...content.next_event, location: e.target.value }
              })}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500"
            />
          </div>
          <div>
            ...
            <input
              type="text"
              value={content.next_event?.shotgun_url || ''}
              onChange={(e) => setContent({
                ...content,
                next_event: { ...content.next_event, shotgun_url: e.target.value }
              })}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500"
            />
          </div>
          <button
            onClick={() => saveSection('next_event', content.next_event)}
            disabled={loading}
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 px-6 py-3 rounded-lg font-bold transition-all"
          >
            <Save size={20} />
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              onChange={(e) => setContent({
                ...content,
                mission: { ...content.mission, text: e.target.value }
              })}
              rows={4}
              className="w-full bg-gray-800 border border-gray-700 rounded-lg px-4 py-3 text-white focus:outline-none focus:border-red-500"
            />
          ...
          <button
            onClick={() => saveSection('mission', content.mission)}
            disabled={loading}
            className="flex items-center gap-2 bg-green-600 hover:bg-green-700 disabled:bg-gray-700 px-6 py-3 rounded-lg font-bold transition-all"
          >
            <Save size={20} />
